...
<script>
	...
	export default{
		...
		methods:{
			...
			loadMore() {
				...
				if(this.currentPage>this.totalPages){
			  	...
			  	axios.get(`/appapi/silo/eventForH5?categoryId=crossborder&pageIndex=${this.currentPage}&timestamp=1542776880651&summary=dac44326b3d77c9907964b9cbcb0656d&platform_code=H5`).then(res=>{
		...
		mounted(){
			axios.get("/appapi/home/mktBannerApp/v3?silo_id=2013000100000000011&platform_code=PLATEFORM_H5")
			.then(res=>{
			...
			axios.get("/appapi/cms/cmsDetail/v3?silo=2013000100000000011&ids=2041000100000000206&timestamp=1542772628744&summary=e5999f4bd1ce6e13b9e1ff1438907423&platform_code=H5").then(res=>{
				this.lilist = res.data.resultList[0].data;
			}).catch(err=>{
				console.log('请求失败');
			})

			axios.get("/appapi/silo/eventForH5?categoryId=crossborder&pageIndex=1&timestamp=1542776880651&summary=dac44326b3d77c9907964b9cbcb0656d&platform_code=H5").then(res=>{
