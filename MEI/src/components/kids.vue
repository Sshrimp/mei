...
<script>
	...
	export default{
		...
		methods:{
			...
			loadMore() {
				...
				if(this.currentPage>this.totalPages){
			  	...
			  	axios.get(`/appapi/silo/eventForH5?categoryId=kids&pageIndex=${this.currentPage}&timestamp=1543019451448&summary=de6fd046b33306ddb8bc0912786c4921&platform_code=H5`).then(res=>{
		...
		mounted(){
			axios.get("/appapi/home/mktBannerApp/v3?silo_id=2013000100000000005&platform_code=PLATEFORM_H5")
			.then(res=>{
			...
			axios.get("/appapi/cms/cmsList/v3?silo=2013000100000000005&timestamp=1543019451448&summary=a17f8a9714f41377057409f846eb0021&platform_code=H5").then(res=>{
				this.lilist = res.data.resultList[0].data;
			}).catch(err=>{
				console.log('请求失败');
			})

			axios.get("/appapi/silo/eventForH5?categoryId=kids&pageIndex=1&timestamp=1543019451448&summary=de6fd046b33306ddb8bc0912786c4921&platform_code=H5").then(res=>{
