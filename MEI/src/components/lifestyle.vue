...
<script>
	...
	export default{
		...
		methods:{
			...
			loadMore() {
				...
				if(this.currentPage>this.totalPages){
			  	...
			  	axios.get(`/appapi/silo/eventForH5?categoryId=lifestyle&pageIndex=${this.currentPage}&timestamp=1543019175503&summary=b4e198c635b7af5ac42f770efb5765a7&platform_code=H5`).then(res=>{
		...
		mounted(){
			axios.get("/appapi/home/mktBannerApp/v3?silo_id=2013000100000000004&platform_code=PLATEFORM_H5")
			.then(res=>{
			...
			axios.get("/appapi/cms/cmsList/v3?silo=2013000100000000004&timestamp=1543019175493&summary=3e89bec6ff85db046fceb3cf1c2caa6e&platform_code=H5").then(res=>{
				this.lilist = res.data.resultList[0].data;
			}).catch(err=>{
				console.log('请求失败');
			})

			axios.get("/appapi/silo/eventForH5?categoryId=lifestyle&pageIndex=1&timestamp=1543019175503&summary=b4e198c635b7af5ac42f770efb5765a7&platform_code=H5").then(res=>{
